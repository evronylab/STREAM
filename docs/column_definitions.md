...
| sample_frac_filter_H | TRUE/FALSE whether the locus passed the minimum required fraction of samples passing HipSTR filters. |
| sample_frac_filter_G | TRUE/FALSE whether the locus passed the minimum required fraction of samples passing GangSTR filters. |
| sample_frac_filter_E | TRUE/FALSE whether the locus passed the minimum required fraction of samples passing ExpansionHunter filters. |
