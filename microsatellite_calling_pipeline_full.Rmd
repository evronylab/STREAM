...
nonA.min.mallreads.hipstr <- as.numeric(args[4])
A.min.mallreads.hipstr <- as.numeric(args[26])
...
nonA.min.allele.mallreads.hipstr <- as.numeric(args[5])
A.min.allele.mallreads.hipstr <- as.numeric(args[27])
...
nonA.min.mvaf.hipstr <- as.numeric(args[6])
A.min.mvaf.hipstr <- as.numeric(args[28])
...
nonA.min.allreads.hipstr <- as.numeric(args[55])
A.min.allreads.hipstr <- as.numeric(args[58])
...
nonA.min.allele.allreads.hipstr <- as.numeric(args[56])
A.min.allele.allreads.hipstr <- as.numeric(args[59])
...
nonA.min.avaf.hipstr <- as.numeric(args[57])
A.min.avaf.hipstr <- as.numeric(args[60])
...
nonA.max.stutter.frac.hipstr <- as.numeric(args[47])
A.max.stutter.frac.hipstr <- as.numeric(args[50])
...
nonA.max.flankindel.frac.hipstr <- as.numeric(args[48])
A.max.flankindel.frac.hipstr <- as.numeric(args[51])
...
nonA.min.gldiff.hipstr <- as.numeric(args[49])
A.min.gldiff.hipstr <- as.numeric(args[52])
...
nonA.min.mean.mallreads.hipstr <- as.numeric(args[15])
A.min.mean.mallreads.hipstr <- as.numeric(args[37])
...
nonA.min.mean.allreads.hipstr <- as.numeric(args[61])
A.min.mean.allreads.hipstr <- as.numeric(args[62])
