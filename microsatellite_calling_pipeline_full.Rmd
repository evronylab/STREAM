...
### f. Make interval list (GBM panel)

gbm_bed_to_interval_list.sh
```{bash}
#!/bin/bash

# SBATCH --time=100

# Usage: gbm_bed_to_interval_list.sh [gbm_panel.bed] [output file full path] [reference genome dictionary file]
# output file must end in .interval_list

# gbm_panel.bed is a bed that contains the coordinates for the targets of the GBM capture panel
# gbm_panel.bed has 0-start, half-open coordinates
# requires gbm_panel.bed to be in the following order:
# [chr] [start] [end]
# Interval list coordinates are 0-start, half-open
...
sbatch /scratch/cal8150/uSatAnalysis/scripts/gbm_bed_to_interval_list.sh /scratch/cal8150/uSatAnalysis/loci/gbm_panel.bed /scratch/cal8150/uSatAnalysis/scripts/gbm_bed_to_interval_list.sh /scratch/cal8150/uSatAnalysis/loci/gbm_panel.interval_list /scratch/projects/evronylab/reference-files/hg38-gatk/Homo_sapiens_assembly38.dict
```
...
// GBM variant panel (if none, set to false)
params.gbm_panel = false
...
workflow {
  ...
  if( params.gbm_panel )
    GBM_VARIANTS( SORT_BAM.out.cram )
  else
    println 'Not performing GBM panel genotyping, since no panel specified'
...
// Genotype variants from GBM panel if present

process GBM_VARIANTS {
