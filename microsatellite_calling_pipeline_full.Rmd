...
# Usage: gbm_bed_to_interval_list.sh [gbm_panel.bed] [reference genome dictionary file]

# gbm_panel.bed is a bed that contains the coordinates for the targets of the GBM capture panel
# gbm_panel.bed has 1-start, fully closed coordinates
...
awk -F'\t' -e '{print $1"\t"($2-1)"\t"$3}' $1 > ${GBM}

java -jar /scratch/projects/evronylab/bin/gatk/picard.jar BedToIntervalList \
          I=${GBM} \
          O=$(dirname $1)/$(basename $1 .csv).interval_list \
          SD=$2
