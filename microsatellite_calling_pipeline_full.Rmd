...
filtering_function <-
  ...
  mutate(HipSTR_passsample =
           ...
           case_when(sex == "M" & (chr == "chrX" | chr == "chrY") &
                     ...
                     # allele 1 VAF
                     H_MVAF_1 >= min.vaf.hipstr & !is.na(H_MVAF_1) &
                     # stutter fraction
                     H_DSTUTTER/H_DP <= nonA.max.stutter.frac.hipstr & !is.na(H_DSTUTTER) &
                     # flank indel fraction
                     H_DFLANKINDEL/H_DP <= nonA.max.flankindel.frac.hipstr & !is.na(H_FLANKINDEL) &
                     # likelihood difference
                     H_GLDIFF >= nonA.min.gldiff.hipstr & !is.na(H_GLDIFF) ~ TRUE,
                     ...
                     H_MVAF_1 >= min.vaf.hipstr & !is.na(H_MVAF_1) &
                     # allele 2 VAF
                     H_MVAF_2 >= min.vaf.hipstr & !is.na(H_MVAF_2) &
                     # stutter fraction
                     H_DSTUTTER/H_DP <= nonA.max.stutter.frac.hipstr & !is.na(H_DSTUTTER) &
                     # flank indel fraction
                     H_DFLANKINDEL/H_DP <= nonA.max.flankindel.frac.hipstr & !is.na(H_FLANKINDEL) &
