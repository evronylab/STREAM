...
nonA_results_stats <- results %>% group_by(name, chr, motif.family, caller) %>% summarise() %>% filter(motif.family != "A")
A_results_stats <- results %>% group_by(name, chr, motif.family, caller) %>% summarise() %>% filter(motif.family == "A")
