...
filtering_function <-
  ...
  subset_data <- subset_data %>%
    ...
    # choose caller based on preference
    mutate(caller = if_else(get(paste0(caller.one,"_passlocus")) == T, caller.one,
                            if_else(get(paste0(caller.two,"_passlocus")) == T & caller.two != "no_caller", caller.two,
                                    if_else(get(paste0(caller.three,"_passlocus")) == T & caller.three != "no_caller", caller.three, "no call"))))
