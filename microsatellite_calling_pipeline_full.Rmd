...
# Usage: gbm_bed_to_interval_list.sh [gbm_panel.bed] [output file basename] [reference genome dictionary file]
...
sbatch /scratch/cal8150/uSatAnalysis/scripts/gbm_bed_to_interval_list.sh /scratch/cal8150/uSatAnalysis/gbm_panel.bed /scratch/projects/evronylab/reference-files/hg38-gatk/Homo_sapiens_assembly38.dict
```
